...
public abstract class Event {
    ...
    protected Event(int eventId,String eventName,String eventDescription,String eventActivities,double admissionFees)
    {
	...
	/***
         * Implement calculateAdmissionFee() by using the rate and duration defined into Constants
         */
