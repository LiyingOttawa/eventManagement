/**
 * File name: WorkshopEventCreator.java
 * Author: Liying Guo, 040858257
 * Course: CST8288 OOP with Design Patterns
 * Assignment: Assignment2
 * Date: 2024-02-17
 * Professor: Gustavo Adami
 * Purpose: WorkshopEventCreator is EventCreator
 */
...
/**
 * This class is a factory class to create a work shop Event
 * @author Liying Guo
 * @version 1.0
 * @since 2024-Feb-17
 */
public class WorkshopEventCreator extends EventCreator {
    ...
    public Event makeEvent() {
        return new WorkshopEvent(this.eventId,this.eventDescription,this.eventActivities,this.admissionFees);
    }
